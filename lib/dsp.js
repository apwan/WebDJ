...
WindowFunction.prototype.gen = function(buffer) {
  var length = buffer.length;
  // edited by Yijie on April 28, 2019
  var func = this.func, alpha = this.alpha;
  return buffer.map(function(e,i){
    return e * func(length, i, alpha);
  });
